...
var MathModelDefService = /** @class */ (function () {
    function MathModelDefService() {
        ...
        this.constraintComps.push({ constraintId: 'nodeBal', elementType: 'gen', propertyMapToParent: 'toBus',
            ...
            varType: 'branchFlow', multParentProperty: '', multValue: 1 }, { constraintId: 'genSumTranches', elementType: 'enOfferTranche', propertyMapToParent: 'parentId',
            varType: 'trancheCleared', multParentProperty: '', multValue: -1 }, { constraintId: 'loadSumTranches', elementType: 'bidTranche', propertyMapToParent: 'parentId',
            ...
            varType: 'phaseAngle', multParentProperty: '', multValue: 1 }, { constraintId: 'objective', elementType: 'enOfferTranche', propertyMapToParent: 'genPrice',
            varType: 'trancheCleared', multParentProperty: '', multValue: -1 }, { constraintId: 'objective', elementType: 'bidTranche', propertyMapToParent: 'loadPrice',
